...
- v2.4.2 之后的 conversation / memory 持久化必须作为独立阶段设计和审计，先补 deletion、retention、backup、export、privacy mode、secret/sensitive blocking、用户可见控制、migration 和回滚验收；不得从 in-memory harness 直接演进为未审核磁盘写入。
