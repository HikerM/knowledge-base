...
- conversation persistence 只能通过 v2.5.3 `ConversationPersistenceService` 显式 service API；memory persistence 仍是 future work，GUI、AI provider、ViewModel、CLI wrapper 和静态 model 不得直接读写 conversation、memory 或 draft 文件。
