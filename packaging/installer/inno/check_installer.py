...
INSTALLER_PATH = OUTPUT_DIR / "PersonalKnowledgeBase-Setup-v2.0.0.exe"
...
def main(argv: list[str] | None = None) -> int:
    ...
    check(INSTALLER_PATH.name == "PersonalKnowledgeBase-Setup-v2.0.0.exe", "installer_filename", details, errors, "installer filename is incorrect")
