...
valid_for: ["repository-level Codex instructions", "AGENTS.md maintenance", "agent behavior governance"]
...
content_hash: ""
risk_level: medium
verification_method: "Not verified yet. Human reviewer must compare against official AGENTS.md guidance and test instruction behavior in at least one repository workflow before promotion."
